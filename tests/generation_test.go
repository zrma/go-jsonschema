...
import (
	...
	"github.com/zrma/go-jsonschema/pkg/generator"
)
	...
	cfg.SchemaMappings = []generator.SchemaMapping{
		{
			...
			PackageName: "github.com/zrma/go-jsonschema/tests/helpers/schema",
			OutputName:  "schema.go",
		},
		{
			SchemaID:    "https://example.com/other",
			PackageName: "github.com/zrma/go-jsonschema/tests/data/crossPackage/other",
...
func TestCrossPackageNoOutput(t *testing.T) {
	...
	cfg.SchemaMappings = []generator.SchemaMapping{
		...
		{
			SchemaID:    "https://example.com/other",
			PackageName: "github.com/zrma/go-jsonschema/tests/helpers/other",
		},
	}
